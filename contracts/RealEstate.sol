...
contract RealEstate is ERC721URIStorage  { // this is how we make the contract create nfts for our system
using Counters for Counters.Counter;
    ...
    function mint(string memory tokenURI) // when we create nfts we start off with 0 then create one. 
        public
        returns (uint256)
    {
        _tokenIds.increment();
